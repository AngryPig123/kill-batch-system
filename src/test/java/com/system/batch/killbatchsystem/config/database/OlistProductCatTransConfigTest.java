 ...
 * fileName       : OlistProductCatTransConfigTest
 * author         : AngryPig123
 * date           : 26. 1. 11.
 * description    :
 * ===========================================================
...
@SpringBootTest
@SpringBatchTest
class OlistProductCatTransConfigTest extends BatchTestAbstractClass {
    ...
    void 실행() throws Exception {
        Job job = jobRegistry.getJob("olistProductCatTransJob");
